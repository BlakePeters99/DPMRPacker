...
public class PackerTester {
   ...
   public static Item[] randomItemCreator(int amount, int minRangeV,
    int maxRangeV, int minRangeW, int maxRangeW) {
      Item[] itemArray = new Item[amount];
      for (int i = 0; i < amount; i++){
         itemArray[i] = new MyItem((int) (Math.random() * (maxRangeV
          - minRangeV + 1) + minRangeV),
